...
const { deleteDisk, copyDisk, moveDisk, listDisk, linkDisk } = require("../nodejs/disk/index.js");
...
let apis = {
    animation, deeplog, linelog, throttle, logform, deleteDisk, copyDisk, moveDisk, listDisk, linkDisk, reader, strToJson,
};
